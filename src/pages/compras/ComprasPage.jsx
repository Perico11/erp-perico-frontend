...
/* (jun 2026, auditoria) ELIMINADO codigo muerto: _ocEstadoVisual, _ocPagoLabel,
   useOCActions, OCButtons, OCCreditAlert, OCDeskRow, OCMobileCard + constantes
   BTN/BTN_SM/iconos. NO se renderizaban: ComprasPage usa OCsTabResponsive ->
   ComprasScreen. Los helpers vivos (_ocMonto/_ocProducto/_ocFleteFmt/_ocKgTotal/
   _ocMPLabel/_ocBucket) quedan arriba; ocsForScreen los sigue usando. */
