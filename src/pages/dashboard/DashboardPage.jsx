...
export default function DashboardPage() {
  ...
  const cards = [
    ...
    /* 9-sep-2026 (dueño): el puente ya no depende de Luis — Enrique marca
       "Producto enviado" desde Stock Fábrica. La tarjeta queda como respaldo
       del camino de recolección, sin prometer que Luis va a pasar. */
